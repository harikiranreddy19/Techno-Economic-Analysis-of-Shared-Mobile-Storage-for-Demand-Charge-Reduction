...
UserCharLim = (15*chargertype/4)*ones(NumUsers,1);
EVCharLim = 15*chargertype/4;
...
%%
logfilename = ['Log_NumDrivers',num2str(NumDrivers), ...
               '_ChargerType',num2str(chargertype), ...
...
% filename = ['NumDrivers',num2str(NumDrivers),'ChargerType',num2str(chargertype),'Month',num2str(month),'MIP'];
% save(filename)
drawnow
end
end
