...
NDep = 30;
DepCostPerkWhArr = linspace(0.5,1,NDep);
for i = 1:NDep
    evParam.DepCostPerkWh = DepCostPerkWhArr(i);
for month = 1:8 
for NumDrivers = 1                 % 1:5
...
filename = ['MixedSetup','NumDrivers',num2str(NumDrivers),'Month',num2str(month),'AlgoNewDep',num2str(i)];
save(filename)
drawnow
end
end
